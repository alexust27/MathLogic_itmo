#ifndef MATHLOGIC_DEDUCTION_H
#define MATHLOGIC_DEDUCTION_H
...
private:
    ...
    string make_first_str(string first_str) {
        ...
        string main_str = std::move(first_str);
